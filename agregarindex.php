<html>
	...
	<form action="Agregar.php?user=<?php echo $usu;?>" method="POST" enctype="multipart/form-data">
	<table>
	  <tr>
                    <th>Imagen</th>
                    <th>Producto</th>
	  ...
	  <tr>			
			...
			<img src="Image Icon.png" id="vistaprevia" class="contenedor"> </form>
		    </label>
			<br>
		    </form>
		</td>
			<td><input type="text" maxlength="30" name="Producto"></td>
		...
		<center><br><input type="submit" value="Agregar" class="button"></center><br>
	</form>
    </div>
</section>
<script>
