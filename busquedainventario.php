<html>
	...
	<header id="navegator">
		...
		<table>
			<tr>
				<td> <form action="busquedainventario.php" Method="POST"><input type="text" placeholder="Buscar productos..." name = "busqueda" id="busqueda"></form> </td>
		...
		?>
			...
			<tr>
				...
				<td><form action="modificarindex.php?id=<?php echo $row['No_Producto'];?>" method="POST"><input type="submit" value="Modificar"></form></td>
				<td><form action="Eliminar.php?id=<?php echo $row['No_Producto'];?>" method="POST"><input type="submit" value="Eliminar"></form></td>
			</tr> 
	<?php
