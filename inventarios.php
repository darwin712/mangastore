<html>
	...
	<header id="navegator">
		...
		<table>
			<tr>
				<td> <form action="busquedainventario.php?user=<?php echo $usu;?>" Method="POST"><input type="text" placeholder="Buscar productos..." name = "busqueda" id="busqueda"></form> </td>
				<td> <form action="agregarindex.php?user=<?php echo $usu;?>" Method="POST"> <input type="submit" id="btn" value="Agregar Productos"> </form> </td>
		    </tr>
	    </table>
		...
		?>
			...
			<tbody>
			<tr>
				<td><img alt="" width="100px" height="100px" src="data:image/jpg;base64,<?php echo base64_encode($row['Imagen']); ?>" id="contenedor"><br></td>
				...
				<td><form action="modificarindex.php?id=<?php echo $row['No_Producto'];?>&user=<?php echo $usu;?>" method="POST"><input type="submit" value="Modificar"></form></td>
				<td><form action="Eliminar.php?id=<?php echo $row['No_Producto'];?>&user=<?php echo $usu;?>" method="POST"><input type="submit" value="Eliminar"></form></td>
			</tr> 
	<?php
